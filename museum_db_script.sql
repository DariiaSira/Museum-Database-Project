...
ALTER TABLE "Exhibitions"
    ...
    ADD CONSTRAINT CHK_ExhibitionsDateFormat
        CHECK ((start_date IS NULL OR start_date = start_date::timestamp AT TIME ZONE 'UTC'
            AND end_date IS NULL OR end_date = end_date::timestamp AT TIME ZONE 'UTC'));
...
ALTER TABLE "Control"
    ...
    ADD CONSTRAINT CHK_ControlDateFormat
        CHECK ((control_date IS NULL OR control_date = control_date::timestamp AT TIME ZONE 'UTC'
            AND shipping_date IS NULL OR shipping_date = shipping_date::timestamp AT TIME ZONE 'UTC'
            AND delivery_date IS NULL OR delivery_date = delivery_date::timestamp AT TIME ZONE 'UTC')),
